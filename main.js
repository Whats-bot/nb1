...
//jadibot/serbot
case 'арендабот': case 'арендабот': case 'арендабот':
...
break  
case 'estado': case 'инфобота': case 'owner': case 'создатель': case 'contacto': case 'grupos': case 'группы': case 'скриптбота': case 'crearbot': case 'ping': case '5492266613038': case '593980586516': case '595975740803': case 'report': case 'исходник': case 'donar': case 'solicitud': case 'ботвгруппу': case 'cuenta': case 'инфо': case 'cuentaofc': info(command, conn, m, speed, sender, fkontak, pickRandom, pushname, from, msg, text) 
break 
  
//activar/desactivar
case 'welcome': case 'приветствие': case 'antilink': case 'антиссылка': case 'antifake': case 'антифейк': case 'antiarabe': case 'антиараб': case 'autodetect': case 'detect': case 'audios': case 'аудио': case 'autosticker': case 'автостикер': case 'modocaliente': case 'antinsfw': case 'modoadmin': case 'modoadmins': case 'толькоадмины': case 'antiprivado': case 'антиличка': case 'anticall': case 'антизвонок': case 'modojadibot': case 'jadibot': case 'autoread': case 'autovisto': case 'antispam': case 'антиспам': case 'chatbot': case 'чатбот': case 'autolevelup': case 'автоуровень': enable(m, command, isGroupAdmins, text, command, args, isBotAdmins, isGroupAdmins, isCreator) 
break

//Grupos 
case 'grupo': case 'delete': case 'del': case 'join': case 'ботавгруппу': case 'hidetag': case 'notificar': case 'tag': case 'setppgroup': case 'setpp': case 'setppname': case 'nuevonombre': case 'newnombre': case 'setdesc': case 'descripción': case 'anularlink': case 'resetlink': case 'revoke': case 'add': case 'добавить': case 'invitar': case 'kick': case 'снести': case 'echar': case 'sacar': case 'promote': case 'датьадмина': case 'demote': case 'снятьадмина': case 'link': case 'linkgc': case 'banchat': case 'внимание': case 'invocar': case 'todos': case 'админы': case 'administradores': case 'infogrupo': case 'инфогруппы': case 'warn': case 'advertencia': case 'unwarn': case 'quitardvertencia': case 'listwarn': case 'enline': case 'online': case 'listonine': case 'listaenlinea': case 'enlinea': case 'listonline': grupo(m, command, isGroupAdmins, text, conn, participants, isBotAdmins, args, isCreator, delay, sender, quoted, mime, from, isCreator, groupMetadata, fkontak, delay) 
break    
...
//descargas
case 'play': case 'песня': case 'music': case 'play2': case 'video': case 'play3': case 'playdoc': case 'playaudiodoc': case 'ytmp3doc': case 'play4': case 'playdoc2': case 'playvideodoc': case 'ytmp4doc': case "ytmp3": case "ytaudio": case 'ytmp4': case 'ytvideo': case 'music': case 'spotify': case 'gitclone': case 'tiktok': case 'tt': case 'lyrics': case 'letra': case 'mediafire': case 'facebook': case 'fb': case 'instagram': case 'ig': case 'igstalk': case 'apk': case 'modoapk': case 'gdrive': case 'tiktokimg': case 'ttimg': case 'play.1': case 'play.2': descarga(m, command, conn, text, command, args, fkontak, from, lolkeysapi)    
break    

//rpg 
case 'reg': case 'регистрация': case 'unreg': case 'myns': case 'серийник': await reg(command, conn, m, sender, text, budy, fkontak, delay, args)
break   
...
//--------------------[ REPORTE/ERRORS ]-----------------------     
let e = String(err) 
conn.sendMessage("79524197466@s.whatsapp.net", { text: "Hola Creador/desarrollador, parece haber un error, por favor arreglarlo 🥲\n\n" + util.format(e), 
